...
const services = [
    ...
    {
        title: "Táxi Pet",
        description: "Serviço de transporte para levar e buscar pets no petshop, clínicas veterinárias ou outros locais. Ideal para tutores que não tem tempo ou transporte adequado para locomover os animais.",
        duration: "1h-2h",
        price: "R$100",
        icon: <CarTaxiFront/>,
    ...
    return (
        <section className="bg-white py-16">
            <div className="container mx-auto px-4">
                <div>
                    <h2 className="text-4xl text-center font-bold mb-12" data-aos="zoom-in" data-aos-delay="300">Serviços</h2>
                        ...
                        <div className='overflow-hidden' ref={emblaRef}>
                            <div className='flex'>
                                {services.map((item, index) => (
                                    <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3" data-aos="zoom-in" data-aos-delay="300">
                                        <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                            ...
                                            <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                                ...
                                                <a 
                                                    target='_blank'
                                                    href={`https://wa.me/5591984536649?text=Olá, vim pelo site e gostaria de mais informações sobre ${item.title}.`}
